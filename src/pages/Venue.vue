<template>
    <div>
      <HeroImage text="Dreams Royal Beach" :image="`url('dreams_royal_beach_overhead_view.webp')`" />
      <div>
        <h3>Booking</h3>
        <ul>
          ...
          <li>Minimum suggested stay: <b>1/6/24</b>(afternoon arrival)-<b>1/8/24</b> (morning departure)</li>
        </ul>
      </div>
    </div>
</template>
